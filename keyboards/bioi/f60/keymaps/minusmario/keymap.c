...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_60_ansi(
        ...
        MO(_FN_2), KC_LCTL, KC_LALT, LT(_FN_1,KC_SPC),                     KC_RGUI, RALT_T(KC_LEFT), RGUI_T(KC_DOWN), RCTL_T(KC_RIGHT)
    ),
    [_FN_1] = LAYOUT_60_ansi(
        KC_GRV,KC_F1,KC_F2,KC_F3,KC_F4,KC_F5,KC_F6,KC_F7,KC_F8,KC_F9,KC_F10,KC_F11,KC_F12,    KC_TRNS,
        KC_TRNS,  DYN_REC_START1,DYN_REC_START2,KC_INSERT,KC_HOME,KC_PGUP,VIM_YANK,KC_NO,KC_NO,KC_NO,VIM_PASTE,LCTL(LGUI(KC_LEFT)), LCTL(LGUI(KC_RIGHT)),  KC_NO,
        KC_TRNS,   DYN_MACRO_PLAY1,DYN_MACRO_PLAY2,KC_DELETE,KC_END,KC_PGDOWN,KC_LEFT,KC_DOWN,KC_UP,KC_RIGHT,KC_NO,KC_NO,     KC_TRNS,
        KC_TRNS,     KC_NLCK,KC_CAPS,KC_SLCK,KC_PAUSE,KC_PSCREEN,KC_NO,KC_NO,KC_AUDIO_VOL_DOWN,KC_AUDIO_VOL_UP,KC_MUTE,       KC_TRNS,
        DYN_REC_STOP, KC_TRNS, KC_TRNS, KC_TRNS,                     KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
    ),
